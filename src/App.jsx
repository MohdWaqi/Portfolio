 ...
 useEffect(()=>{
  ...
  return (
    ...
    <div>
      ...
      <a href='https://www.google.co.in/' target="_blank" download="MohdWaqi-Pervez-Resume.pdf"><button className='btn'>Resume</button></a>
    </div>
    ...
    <div name='skills' className='sections'>
      ...
      <div className='skills'>
        <img data-aos="fade-up" src='https://cdn1.iconfinder.com/data/icons/logotypes/32/badge-html-5-512.png'/>
        <img data-aos="fade-up" src='https://cdn1.iconfinder.com/data/icons/logotypes/32/badge-css-3-512.png'/>
        <img data-aos="fade-up" src='https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/tailwind-css-icon.png'/>
        <img data-aos="fade-up" src='https://cdn2.iconfinder.com/data/icons/designer-skills/128/code-programming-javascript-software-develop-command-language-256.png'/>
        <img data-aos="fade-up" src='https://cdn4.iconfinder.com/data/icons/logos-3/600/React.js_logo-256.png'/>
        <img data-aos="fade-up" src={chakra}/>
        <img data-aos="fade-up" src='https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/bootstrap-5-logo-icon.svg'/>
        <img data-aos="fade-up" src='https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/postman-icon.svg'/>
        <img data-aos="fade-up" src='https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/267_Python_logo-256.png'/>
        <img data-aos="fade-up" src='https://cdn3.iconfinder.com/data/icons/social-media-2169/24/social_media_social_media_logo_git-512.png'/>
        <img data-aos="fade-up" src='https://cdn0.iconfinder.com/data/icons/shift-logotypes/32/Github-256.png'/>
        <img data-aos="fade-up" src='https://uxwing.com/wp-content/themes/uxwing/download/internet-network-technology/artificial-intelligence-ai-icon.svg'/>
      </div>
    ...
    <div name='contact' className='sections contact'>
      ...
      <div>
        <a href='https://www.linkedin.com/in/mohd-waqi-pervez-52a432291/'><img src="https://cdn1.iconfinder.com/data/icons/logotypes/32/square-linkedin-256.png"/></a>
        <a href='mailto:mohdwaqipervez@gmail.com'><img src={emailIcon}/></a>
        <a href='https://github.com/MohdWaqi'><img src="https://cdn4.iconfinder.com/data/icons/iconsimple-logotypes/512/github-256.png"/></a>
        <a href="https://api.whatsapp.com/send?phone=918755075132&text=Hello Waqi"><img src="https://cdn2.iconfinder.com/data/icons/social-micon/512/whatsapp-256.png"/></a>
        <a href='tel:+918755075132'><img src="https://cdn3.iconfinder.com/data/icons/google-material-design-icons/48/ic_local_phone_48px-256.png"/></a>
      </div>
